...
public abstract class PuntiVendita  {
	...
	public PuntiVendita(String nome, Long biglietti_emessi, Long abbonamenti_emessi) {
		super();
		this.nome = nome;
	...
	public String toString() {
		return "PuntiVendita [id=" + id + ", nome=" + nome + ", biglietti_emessi=" + biglietti_emessi
				+ ", abbonamenti_emessi=" + abbonamenti_emessi + "]";
	}
